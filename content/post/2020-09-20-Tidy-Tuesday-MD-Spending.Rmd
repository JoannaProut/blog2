...
I limited the date to Maryland and the years of 2011-2016 and used a "bumpchart" to look at the ranking of categories of spending over time (from most money to least money spent).
...
ggplot(bind5, aes(x = as.factor(year), y = rank, group = variable)) +
  ...
  labs(x = ' ', y = '', 
       ...
       subtitle = 'Thousands of $ per child (adjuted for inflation)',
